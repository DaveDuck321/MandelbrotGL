...
import GL_State, {getUniformLocation, NewState} from "../webgl/webgl.js"
...
export default function drawFrame(opengl: GL_State, corners:Viewport, precision:number) {
    let {ctx} = opengl;
...
export function newGraphicState(precision:number):GL_State {
